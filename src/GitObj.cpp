...
void GitObj::addRemote(const std::string& remoteName, const std::string& remotePath) {
    repo.addRemote(remoteName, remotePath);
}
...
void GitObj::push(const std::string& remoteName, const std::string& remoteBranchName) {
    repo.push(remoteName, remoteBranchName);
}

void GitObj::fetch(const std::string& remoteName, const std::string& remoteBranchName) {
    repo.fetch(remoteName, remoteBranchName);
}

void GitObj::pull(const std::string& remoteName, const std::string& remoteBranchName) {
